/**
 * Standalone Enhanced Export Service - not inheriting from base to avoid conflicts
 */
...
export class StandaloneEnhancedExportService {
  ...
  public async exportData(
    ...
    try {
      ...
      if (options.outputPath) {
        console.log('Attempting to save file to:', options.outputPath);
