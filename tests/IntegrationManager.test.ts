...
import { GitHubProvider } from '../src/integrations/GitHubProvider.js';
import { GitLabProvider } from '../src/integrations/GitLabProvider.js';
import { RepositoryMetadata, BranchEnrichment } from '../src/integrations/types.js';

// Mock the providers
jest.mock('../src/integrations/GitHubProvider.js');
jest.mock('../src/integrations/GitLabProvider.js');
